...
{
    public partial class updatedbfile : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "cashregistry_user",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cashregistry_user", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_order_cashregistry_user_user_id",
                        column: x => x.user_id,
                        principalTable: "cashregistry_user",
                        principalColumn: "id",
